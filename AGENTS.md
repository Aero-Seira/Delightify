...
当前阶段：**M0 - 工程骨架与约束落地（v0.1）**

| 里程碑 | 版本 | 核心交付物 |
|--------|------|------------|
| M0 | v0.1 | 工程骨架、IPC 框架、基础配置读取 |
| M1 | v0.2 | global.db、JAR 导入闭环、三策略提取 |
| M2 | v0.3 | 物品浏览器、材质渲染、查询优化 |
| M3 | v0.4 | 配方浏览器、配方类型元数据驱动 |
| M4 | v0.5 | 可视化配方编辑、KubeJS 导出 |
| M5 | v0.6 | 语义关系系统、global 推荐 + project 覆盖 |
| M6 | v0.7 | LLM 批量迁移工作流（可选） |
| M7 | v0.8 | 打包分发、稳定性优化 |
